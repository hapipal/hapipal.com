        ...
        options: {
            ...
            pre: [
                ...
                [
                    {
                        assign: 'latest',
                        method: async ({ params, pre }) => pre.pkg.npm && await srv.services().npm.version(params.pkgName)
                    },
                    {
                        assign: 'versions',
                        method: async ({ params, pre }) => pre.pkg.npm && await srv.services().npm.versions(params.pkgName)
                    }
                ]
            ],
