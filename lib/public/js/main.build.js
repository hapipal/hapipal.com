...
DocsNav.init(document.querySelector('.docs-detail .wrapper'), document.querySelector('.docs-detail nav.docs-nav'), document.querySelector('.docs-detail nav.docs-nav > .nav-target'));
