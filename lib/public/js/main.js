...
const docsNavMobileActions = () => {
    ...
    const docsNavLinks = docsNav.getElementsByClassName('nav-item');
    ...
    Array.from(docsNavLinks).forEach((link) => {

        link.addEventListener('click', () => docsNav.classList.remove('docs-nav--open'));
    });
};
